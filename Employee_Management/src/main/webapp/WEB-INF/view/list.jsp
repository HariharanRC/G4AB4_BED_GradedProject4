...
<body>
	...
	<div>
		<form action="/Employee_Management/login" method="post">
			<input type="submit" name="s" style="float: right" value="Logout" />
		</form>
		<br> <br> <br>
		<form action="/Employee_Management/student/addForm" method="post">
	...
	<div>
		...
		<table>
			...
			for (Student student : studList) {
				...
				"</td><td><a href='/Employee_Management/student/showFormUpdate?studId="
				+ student.getStudId() + "'>Update</a> | " + 
				"<a href='/Employee_Management/student/delete?studId="+ student.getStudId()
